...
; ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
	...
	Space & c:: ; » chrome, All chrome.
		...
		return ; §
	Space & z:: GroupActivate, gVimAHK_Group, R      ; operaBrowser
	Space & m:: GroupActivate, gVimAHK_Group, R
	Space & p:: GroupActivate, Cplusplus_Group, R     ; mozilaFirefox
	; Space & i ; » once
	...
	Space & h:: 
	Space & NUMPAD5:: WinActivate, Google Translate     ; also chrome   ; »
					; WinActivate, Google Translate - Internet Explorer
					; » Or:
						; or: ahk_class IEFrame     ; internet explorer, for google translate
...
; once was marker=´,¸
; vim:foldmethod=marker:fmr=»,§:tabstop=4:shiftwidth=4
